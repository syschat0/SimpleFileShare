...
Git 없이 받으려면 GitHub 저장소 페이지에서 **Code → Download ZIP**으로 압축 파일을 내려받은 뒤, 압축을 풀고 해당 폴더로 이동하세요.
...
BAT 파일 대신 직접 설정하려면, [Git에서 내려받기](#1-git에서-내려받기)를 완료한 뒤 다음 절차를 따르세요.
...
![Simple File Share 실행 화면](capture_1.png)
